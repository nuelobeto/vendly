...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex min-h-svh flex-col px-4 py-8">
      {/* Brand wash, matching the landing hero */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 -top-40 h-[36rem] bg-[radial-gradient(60%_50%_at_50%_0%,var(--brand-subtle),transparent_70%)]"
      />
